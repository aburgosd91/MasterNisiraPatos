...
import com.nisira.vista.controles.ArrayListTransferHandler;
...
public class JTableUtils {
	...
	public static JList<String> buildRowHeader(final JTable table,
			final NSRTableModelReporte model) {
	...
	static JPopupMenu getnNewPopup(final int row, final NSRTableModel model) {
