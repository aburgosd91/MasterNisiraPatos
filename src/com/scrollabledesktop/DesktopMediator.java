...
public class DesktopMediator implements DesktopConstants {
	 ...
	 *
	 * @param mainPane
	 *            a reference to the JScrollableDesktopPane that this object is
	 *            to mediate.
	 */
	...
	public JInternalFrame add(String title, ImageIcon icon,
		...
		if (desktopScrollpane.getNumberOfFrames() < MAX_FRAMES) {
			...
			JOptionPane
					.showMessageDialog(Inicio.mainF,
							"No puede abrir más Formularios, cierre algunos para continuar.");
		}
	 ...
	 *
	 * @param f
	 *            the internal frame of class BaseInternalFrame to add
	 * @param x
	 *            x coordinates of internal frame within the scrollable desktop
	 *            <code>-1</code> indicates the virtual desktop is to determine
	 *            the position
	...
	public void add(JInternalFrame frame, int x, int y) {
		...
		if (desktopScrollpane.getNumberOfFrames() < MAX_FRAMES) {
			...
			JOptionPane
					.showMessageDialog(Inicio.mainF,
							"No puede abrir m�s Formularios, cierre algunos para continuar.");
		}
	}
	...
	/**
	 * removes the secondary components associated with an internal frame, such
	 * as toggle and menu buttons, and selects the next available frame
	 *
	 * @param f
	 ...
	 *
	 * @param f
	 *            the internal frame to set as selected
	 */
	 ...
	 *
	 * @param f
	 *            the internal frame to center the view about
	 */
	 ...
	 *
	 * @param tileMode
	 *            <code>true</code> indicates tile internal frames,
