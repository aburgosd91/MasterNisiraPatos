...
import com.nisira.vista.utilitarios.DSGVNDetalle;
import com.nisira.vista.utilitarios.JTableUtils;


public abstract class NSRTableModel extends DefaultTableModel {
	/**
	 * 
	 */
	...
	public NSRTableModel() {
		this("Campo 1", "Campo 2");
	}

	public NSRTableModel(String... cabeceras) {
