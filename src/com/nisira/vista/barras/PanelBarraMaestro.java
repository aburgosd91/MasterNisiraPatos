...
public class PanelBarraMaestro extends JPanel {
	...
	public PanelBarraMaestro() {
		...
		btnNuevo.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
				.getResource("/resources/nuevo.png")).getImage()
				.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		add(btnNuevo);
		btnEditar
				.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
						.getResource("/resources/editar.png")).getImage()
						.getScaledInstance(_ancho, _alto,
								java.awt.Image.SCALE_DEFAULT)));
		btnEditar.setToolTipText("Editar");
		add(btnEditar);
		btnAnular
				.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
						.getResource("/resources/anular.png")).getImage()
						.getScaledInstance(_ancho, _alto,
								java.awt.Image.SCALE_DEFAULT)));
		add(btnAnular);
		...
		btnCancelar
				.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
						.getResource("/resources/cancelar.png")).getImage()
						.getScaledInstance(_ancho, _alto,
								java.awt.Image.SCALE_DEFAULT)));
		add(btnCancelar);
		...
		btnGrabar
				.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
						.getResource("/resources/grabar.png")).getImage()
						.getScaledInstance(_ancho, _alto,
								java.awt.Image.SCALE_DEFAULT)));
		add(btnGrabar);
		...
		btnEliminar
				.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
						.getResource("/resources/eliminar.png")).getImage()
						.getScaledInstance(_ancho, _alto,
								java.awt.Image.SCALE_DEFAULT)));
		add(btnEliminar);
		...
		btnSalir.setIcon(new ImageIcon(new ImageIcon(PanelBarraMaestro.class
				.getResource("/resources/salir.png")).getImage()
				.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		add(btnSalir);
