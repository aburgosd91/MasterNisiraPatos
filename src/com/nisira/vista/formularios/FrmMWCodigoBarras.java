...
public class FrmMWCodigoBarras extends FrmMWGeneralPatos{
	
	public FrmMWCodigoBarras(Window mainWindow,String title){
...
//		field.pop.setVisible(false);
	...
	public static void main(String[] args) {
		FrmMWCodigoBarras frm= new FrmMWCodigoBarras(Inicio.mainF,"Prueba");
