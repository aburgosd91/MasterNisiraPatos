...
public class PanelBarraReporte extends JPanel {
	...
	public PanelBarraReporte() {
		...
		btnConsultar.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraReporte.class.getResource("/resources/consultar.png"))
		...
		btnVistaPrevia.setIcon(new ImageIcon(
				new ImageIcon(PanelBarraReporte.class.getResource("/resources/vista_previa.png")).getImage()
						.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		btnVistaPrevia.setToolTipText("Vista Previa");
		add(btnVistaPrevia);
		btnImprimir.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraReporte.class.getResource("/resources/printer.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		btnImprimir.setToolTipText("Imprimir");
		add(btnImprimir);
		btnExportar.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraReporte.class.getResource("/resources/exportar.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnSalir.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraReporte.class.getResource("/resources/salir.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
