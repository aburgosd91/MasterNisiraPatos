...
//	}
	...
	public static void main(String[] args) {
		ClieProv cp = ConsultaRUC("20314727500");
		System.out.println(cp.getIdClieprov());
		System.out.println(cp.getRUC());
		System.out.println(cp.getRazonSocial());
		System.out.println(cp.getDireccion());
