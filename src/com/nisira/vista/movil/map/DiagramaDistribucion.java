...
public class DiagramaDistribucion extends JPanel implements MouseListener,MouseMotionListener,MouseWheelListener{
	...
	public DiagramaDistribucion(List<DZONAGENERAL> listDzonaGeneral ,ConfigTooltip tooltip,int tamanio){
