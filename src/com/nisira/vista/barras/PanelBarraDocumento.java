package com.nisira.vista.barras;
...
public class PanelBarraDocumento extends JPanel {
	...
	public PanelBarraDocumento(char... adicionales) {
		...
		btnNuevo.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource("/resources/nuevo.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		btnNuevo.setToolTipText("Nuevo");
		add(btnNuevo);
		btnEditar.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource("/resources/editar.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		btnEditar.setToolTipText("Editar");
		add(btnEditar);
		btnAnular.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource("/resources/anular.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnCancelar.setIcon(new ImageIcon(
				new ImageIcon(PanelBarraDocumento.class.getResource("/resources/cancelar.png")).getImage()
						.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		btnCancelar.setToolTipText("Cancelar");
		add(btnCancelar);

		btnGrabar.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource("/resources/grabar.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnVerAsiento.setIcon(new ImageIcon(
				new ImageIcon(PanelBarraDocumento.class.getResource("/resources/verasiento.png")).getImage()
						.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnExportar.setIcon(new ImageIcon(
				new ImageIcon(PanelBarraDocumento.class.getResource("/resources/export_document.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));

		btnPrevio = new JButton("");
		btnPrevio.setIcon(new ImageIcon(
				new ImageIcon(PanelBarraDocumento.class.getResource("/resources/vistaprevia.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnImprimir.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource("/resources/printer.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnEliminar.setIcon(new ImageIcon(
				new ImageIcon(PanelBarraDocumento.class.getResource("/resources/eliminar.png")).getImage()
						.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		...
		btnSalir.setIcon(
				new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource("/resources/salir.png"))
						.getImage().getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
	...
	public JPopupMenu getMenu() {
		...
		mExcel.setIcon(getIconResized("/resources/export_excel.png"));
		popupMenu.add(mExcel);

		JMenuItem mWord = new JMenuItem("MS Word");
		mWord.setIcon(getIconResized("/resources/export_word.png"));
		popupMenu.add(mWord);

		JMenuItem mPDF = new JMenuItem("PDF");
		mPDF.setIcon(getIconResized("/resources/export_pdf.png"));
		popupMenu.add(mPDF);

		JMenuItem mOdt = new JMenuItem("ODT");
		mOdt.setIcon(getIconResized("/resources/export_odt.png"));
		popupMenu.add(mOdt);

		JMenuItem mOds = new JMenuItem("ODS");
		mOds.setIcon(getIconResized("/resources/export_ods.png"));
		popupMenu.add(mOds);
	...
	private static Icon getIconResized(String path) {
		return new ImageIcon(new ImageIcon(PanelBarraDocumento.class.getResource(path)).getImage().getScaledInstance(25,
				25, java.awt.Image.SCALE_DEFAULT));
	}
