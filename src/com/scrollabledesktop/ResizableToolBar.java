...
/**
 * Generic self-contained resizable toolbar class. When a button addition
 * exceeds the width of the toolbar container, all buttons within the container
 * are automatically resized to compensate, down to the minimum button width
 * defined upon creation of the ResizableToolbar instance.
 *
...
public class ResizableToolBar extends JToolBar implements ComponentListener {
	 ...
	 *            the minimum button width allowed
	 * @param maxButtonWidth
	 *            the maximum button width allowed
	 */
	...
	/**
	 * resizes the buttons of the toolbar, depending upon the total number of
	 * components stored therein. Executes as an "invoked later" thread for a
	 * slight perceived performance boost.
	 */
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				while (e.hasMoreElements()) {
					...
					int buttonWidth = Math.round(currentButtonXLocation
							+ exactButtonWidth)
	...
	/**
	 * returns the current button width, defined as the width of the
	 * ResizableToolbar divided by the number of buttons. The value returned
	 * ranges from minButtonWidth to maxButtonWidth (two variables defined upon
	 * creation of the ResizableToolbar instance).
	 *
	 ...
	 *
	 * @param b
	 *            the button whose width is to be adjusted
	 * @param buttonWidth
	 *            the new width
	 */
