...
//				.getDesktopPaneForComponent(parentComponent);
		JScrollableDesktopPane toUse = Inicio.desktoppane;
...
//			toUse = JLayeredPane.getLayeredPaneAbove(parentComponent);
		...
		frame.addInternalFrameListener(new InternalFrameListener() {	
			...
			public void internalFrameClosing(InternalFrameEvent arg0) {
				Inicio.desktoppane.getDesktopMediator().getDesktopResizableToolbar().enableButtons();
			}
		...
		Inicio.desktoppane.getDesktopMediator().getDesktopResizableToolbar().disableButtons();
		toUse.add(frame);
