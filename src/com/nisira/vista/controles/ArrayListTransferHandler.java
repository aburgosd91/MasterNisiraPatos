...
public class ArrayListTransferHandler extends TransferHandler {
	...
	protected DataFlavor localArrayListFlavor;
	...
	protected boolean hasLocalArrayListFlavor(DataFlavor[] flavors) {
	...
	protected boolean hasSerialArrayListFlavor(DataFlavor[] flavors) {
